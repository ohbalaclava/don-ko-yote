          ...
          >
            ...
            <div class="px-5 pb-8">
              <div class="flex items-center justify-between mb-4">
                <div>
                  <h2 class="text-xl font-bold dark:text-white">Jiuchi patterns</h2>
                  <p class="text-xs text-gray-500 dark:text-gray-400">{piece.jiuchi}</p>
                </div>
                <button
                ...
                {patterns.map((p) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span class="text-xs text-purple-400 dark:text-purple-500 ml-4">{dur}b</span>
                    </button>
                  );
                })}
              </div>
