  ...
  return {
    view({ attrs: { checked, onChange } }) {
      return (
        ...
        >
          <span class={`absolute top-0.5 left-0.5 w-5 h-5 bg-white rounded-full shadow transition-transform ${checked ? 'translate-x-5' : ''}`} />
        </button>
      );
    }
  };
            ...
            <div class="px-5 pb-8">
              ...
              <div class="flex items-center justify-between py-4 border-b border-gray-200 dark:border-gray-700">
                <div>
                  ...
                  <div class="text-sm text-gray-500 dark:text-gray-400">Tile width reflects beat duration</div>
                </div>
                <Toggle
              ...
              <div class="flex items-center justify-between py-4 border-b border-gray-200 dark:border-gray-700">
                <div>
                  ...
                  <div class="text-sm text-gray-500 dark:text-gray-400">Block notes that would cross a beat boundary</div>
                </div>
                <Toggle
                ...
                <div class="grid grid-cols-2 gap-2">
                  {FONTS.map(f => (
                    ...
                    >
                      ...
                      />
                      <span style={f.style} class="text-sm dark:text-white">{f.label}</span>
                    </label>
                  ))}
                </div>
              </div>
              ...
              <div class="pt-4 flex flex-col gap-2">
                <p class="text-xs text-gray-500 dark:text-gray-400 font-semibold uppercase tracking-wide">Settings file</p>
